import { Component, ChangeDetectionStrategy, input, computed, SecurityContext } from '@angular/core';
...
export type IconName =
  | 'package' | 'package-check' | 'truck' | 'clock'
  | 'check' | 'check-circle' | 'x' | 'x-circle'
  | 'plus' | 'plus-circle' | 'minus' | 'edit' | 'trash'
  | 'search' | 'filter' | 'refresh-cw' | 'loader'
  | 'bell' | 'bell-ring' | 'user' | 'users'
  | 'settings' | 'log-out' | 'log-in' | 'menu'
  | 'chevron-down' | 'chevron-up' | 'chevron-left' | 'chevron-right'
  | 'arrow-left' | 'arrow-right' | 'eye' | 'eye-off'
  | 'mail' | 'lock' | 'map-pin' | 'home' | 'building' | 'hash'
  | 'file-text' | 'dollar-sign' | 'calendar' | 'alert-circle' | 'info'
  | 'sun' | 'moon' | 'wifi' | 'wifi-off'
  | 'more-vertical' | 'external-link' | 'copy'
  | 'bar-chart' | 'trending-up' | 'trending-down' | 'activity';

const ICONS: Record<IconName, string> = {
  'package': '<path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/>',
  'package-check': '<path d="m16 16 2 2 4-4"/><path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l2-1.14"/><path d="m7.5 4.27 9 5.15"/><path d="M3.3 7 12 12l8.7-5"/><path d="M12 22V12"/>',
...
export class IconComponent {
  ...
  readonly safeIconPath = computed((): SafeHtml => {
